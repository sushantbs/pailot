...
export class StorageManager {
   ...
   */
  static async addRecallItem(item: Omit<RecallItem, 'id' | 'createdAt' | 'updatedAt'>): Promise<number> {
    const now = Date.now()
   ...
   */
  static async updateRecallItem(id: number, updates: Partial<RecallItem>): Promise<RecallItem | undefined> {
   ...
   */
  static async addFlightList(list: Omit<FlightList, 'id' | 'createdAt' | 'updatedAt'>): Promise<number> {
    const now = Date.now()
   ...
   */
  static async updateFlightList(id: number, updates: Partial<FlightList>): Promise<FlightList | undefined> {
