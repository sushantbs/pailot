        ...
        {FLIGHT_PHASES.map((phase, index) => {
          ...
          return (
            <div key={phase}>
              ...
              {isActive && (
                <button
                  onClick={() => onAddItemForPhase?.(phase)}
                  className="w-full px-3 py-2 text-xs font-semibold text-blue-300 hover:text-blue-200 bg-blue-900/30 border-l-4 border-blue-400 transition-colors"
                >
                  + New Item
                </button>
              )}
